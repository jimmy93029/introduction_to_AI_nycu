...
class Agent():
    ...
    def discretize_observation(self, observation):
        ...
        # Begin your code
        """
        for each obersvations, cart position, cart velocity, pole angle, tip velocity,
    ...
    def choose_action(self, state):
        ...
        # Begin your code
        """
        To do exporation with deterministic policy, we use eplison-greedy method
    ...
    def check_max_Q(self):
        ...
        """
        """
         get choose max value among all states in initial state's qtable
         """
        # Begin your code
        """
